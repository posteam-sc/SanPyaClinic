...
namespace POS
{
    public partial class ProfitAndLoss_frm : Form
    {
        ...
        public void loadData()
        {
            ...
            if (productId > 0)
            {
                System.Data.Objects.ObjectResult<GetProfitAndLossByProductId_Result> prlist = entity.GetProfitAndLossByProductId(fromDate, toDate, productId);
                foreach (GetProfitAndLossByProductId_Result pr in prlist)
                {
            ...
            {
                System.Data.Objects.ObjectResult<GetProfitAndLossByBrandId_Result> prlist = entity.GetProfitAndLossByBrandId(fromDate, toDate, brandId);
                foreach (GetProfitAndLossByBrandId_Result pr in prlist)
                {
                    ProfitAndLoss pfl = new ProfitAndLoss();
                    pfl.SaleDate = Convert.ToDateTime(pr.SaleDate);
                    pfl.TotalSaleQty = Convert.ToInt32(pr.TotalSaleQty);
            ...
            {
                System.Data.Objects.ObjectResult<GetProfitAndLossByCouterId_Result> prlist = entity.GetProfitAndLossByCouterId(fromDate, toDate, counterId);
                foreach (GetProfitAndLossByCouterId_Result pr in prlist)
                {
                    ProfitAndLoss pfl = new ProfitAndLoss();
                    pfl.SaleDate = Convert.ToDateTime(pr.SaleDate);
                    pfl.TotalSaleQty = Convert.ToInt32(pr.TotalSaleQty);
            ...
            {
                System.Data.Objects.ObjectResult<GetProfitandLoss_Result> prlist = entity.GetProfitandLoss(fromDate, toDate);
        ...
        private void ShowReportViewer()
        {
            ...
            foreach (ProfitAndLoss pdCon in plist)
            {
                ...
                newRow.SaleDate = pdCon.SaleDate.ToString("dd/MM/yyyy");
